...
var It = ((n) => (n.VERBOSE = "VERBOSE", n.INFO = "INFO", n.WARN = "WARN", n.ERROR = "ERROR", n))(It || {});
var w = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
function Ve(n, e, t = void 0) {
  ...
  return function() {
    const c = Date.now();
    !l && t.leading === false && (l = c);
    const u = e - (c - l);
    return o = this, i = arguments, u <= 0 || u > e ? (r && (clearTimeout(r), r = null), l = c, s = n.apply(o, i), r || (o = i = null)) : !r && t.trailing !== false && (r = setTimeout(a, u)), s;
  };
}
function Co() {
  const n = {
...
var d = class _d {
  ...
  static findAllInputs(e) {
    return At(e.querySelectorAll(_d.allInputsSelector)).reduce((t, o) => _d.isNativeInput(o) || _d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ..._d.getDeepestBlockElements(o)], []);
  }
  /**
  ...
  static getDeepestNode(e, t = false) {
    ...
    if (e && e.nodeType === Node.ELEMENT_NODE && e[o]) {
      let s = e[o];
      if (_d.isSingleTag(s) && !_d.isNativeInput(s) && !_d.isLineBreakTag(s))
        if (s[i])
          s = s[i];
...
function Fo(n, e) {
  ...
  return n.type === "attributes" && n.attributeName === "data-empty" ? false : !!(e.contains(o) || t === "childList" && (Array.from(i).some((a) => a === e) || Array.from(s).some((a) => a === e)));
}
...
var A = ((n) => (n.Default = "default", n.Separator = "separator", n.Html = "html", n))(A || {});
var J = ((n) => (n.APPEND_CALLBACK = "appendCallback", n.RENDERED = "rendered", n.MOVED = "moved", n.UPDATED = "updated", n.REMOVED = "removed", n.ON_PASTE = "onPaste", n))(J || {});
var D = class _D extends Te {
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      let u;
      a || c ? u = true : u = !(l.length > 0 && l.every((p) => {
   ...
   */
  compose() {
    const e = d.make("div", _D.CSS.wrapper), t = d.make("div", _D.CSS.content), o = this.toolInstance.render();
...
var ot = class _ot extends y {
  ...
  getMethodsForTool(e, t) {
    return Object.assign(
      this.methods,
      {
        t: (o) => z.t(_ot.getNamespace(e, t), o)
      }
    );
  }
};
  ...
  (function(t, o) {
    ...
    return function(t) {
      ...
      return i.m = t, i.c = o, i.d = function(s, r, l) {
        i.o(s, r) || Object.defineProperty(s, r, { enumerable: true, get: l });
      }, i.r = function(s) {
        ...
        if (i.r(l), Object.defineProperty(l, "default", { enumerable: true, value: s }), 2 & r && typeof s != "string")
          for (var a in s)
            i.d(l, a, (function(c) {
              return s[c];
            }).bind(null, a));
...
`);
      ...
      function j(v, m) {
        ...
        if (m.singleton) {
          var P = h++;
          x = u || (u = _(m)), E = fe.bind(null, x, P, false), M = fe.bind(null, x, P, true);
        } else
...
var Z = ((n) => (n.Closed = "closed", n.ClosedOnActivate = "closed-on-activate", n))(Z || {});
var H = te("ce-popover");
var N = {
  popover: H(),
...
var de = ((n) => (n.NestingLevel = "--nesting-level", n.PopoverHeight = "--popover-height", n.InlinePopoverWidth = "--inline-popover-width", n.TriggerItemLeft = "--trigger-item-left", n.TriggerItemTop = "--trigger-item-top", n))(de || {});
...
var qt = class Zt extends Vt {
  ...
  constructor(e, t) {
    ...
    }, e.nestingLevel !== void 0 && (this.nestingLevel = e.nestingLevel), this.nestingLevel > 0 && this.nodes.popover.classList.add(N.popoverNested), e.scopeElement !== void 0 && (this.scopeElement = e.scopeElement), this.nodes.popoverContainer !== null && this.listeners.on(this.nodes.popoverContainer, "mouseover", (o) => this.handleHover(o)), e.searchable && this.addSearch(), e.flippable !== false && (this.flipper = new le({
    ...
    return function(t) {
      ...
      function s(a, c) {
        for (var u = 0; u < c.length; u++) {
          var h = c[u];
          h.enumerable = h.enumerable || false, h.configurable = true, "value" in h && (h.writable = true), Object.defineProperty(a, h.key, h);
        }
      }
      function r(a, c, u) {
...
var Se = ((n) => (n.Opened = "toolbox-opened", n.Closed = "toolbox-closed", n.BlockAdded = "toolbox-block-added", n))(Se || {});
...
var ne = ((n) => (n[n.Block = 0] = "Block", n[n.Inline = 1] = "Inline", n[n.Tune = 2] = "Tune", n))(ne || {});
var Ie = ((n) => (n.Shortcut = "shortcut", n.Toolbox = "toolbox", n.EnabledInlineTools = "inlineToolbar", n.EnabledBlockTunes = "tunes", n.Config = "config", n))(Ie || {});
var io = ((n) => (n.Shortcut = "shortcut", n.SanitizeConfig = "sanitize", n))(io || {});
var ce = ((n) => (n.IsEnabledLineBreaks = "enableLineBreaks", n.Toolbox = "toolbox", n.ConversionConfig = "conversionConfig", n.IsReadOnlySupported = "isReadOnlySupported", n.PasteConfig = "pasteConfig", n))(ce || {});
var ct = ((n) => (n.IsInline = "isInline", n.Title = "title", n))(ct || {});
var et = ((n) => (n.IsTune = "isTune", n))(et || {});
var dt = class {
  /**
   * @class
...
function Me(n) {
  ...
  if (d.isEmpty(n))
    return true;
  const [t, o] = so();
  return t === null ? false : no(n, t, o, "left");
}
function Ae(n) {
  ...
  const [t, o] = so();
  return t === null ? false : no(n, t, o, "right");
}
var Gi = class extends y {
  /**
...
var ts = class extends y {
  ...
  clearSelection(e, t = false) {
    ...
    if (this.anyBlockSelected && r && l && !b.isSelectionExists) {
      ...
      o.insertDefaultBlockAtIndex(a, true), i.setToBlock(o.currentBlock), Oe(() => {
        const c = e.key;
...
var Re = class _Re extends y {
  ...
  navigateNext(e = false) {
    ...
    return c ? (this.setToBlock(a, this.positions.START), true) : false;
  }
  /**
...
var rs = class extends y {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    super({
      config: e,
      eventsDispatcher: t
    }), this.disabled = false, this.batchingTimeout = null, this.batchingOnChangeQueue = /* @__PURE__ */ new Map(), this.batchTime = ns, this.mutationObserver = new MutationObserver((o) => {
...
var ro = class lo extends y {
  ...
  async processDataTransfer(e, t = false) {
    ...
    !h.trim() || h.trim() === l || !d.isHTMLString(h) ? await this.processText(l) : await this.processText(h, true);
  }
  /**
  ...
  getFilesConfig(e) {
    ...
    !o && !i || (o && !Array.isArray(o) && (I(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (I(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter((s) => To(s) ? true : (I(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), false))), this.toolsFiles[e.name] = {
      extensions: o || [],
      mimeTypes: i || []
    });
  }
  ...
  processHTML(e) {
    ...
    return o.innerHTML = e, this.getNodes(o).map((s) => {
      let r, l = t.defaultTool, a = false;
      switch (s.nodeType) {
        case Node.DOCUMENT_FRAGMENT_NODE:
          r = d.make("div"), r.appendChild(s);
          break;
        case Node.ELEMENT_NODE:
          r = s, a = true, this.toolsTags[r.tagName] && (l = this.toolsTags[r.tagName].tool);
          break;
      }
...
var xe = class _xe extends y {
  ...
  startSelection(e, t) {
    ...
    !r || l || (this.mousedown = true, this.startX = e, this.startY = t);
  }
  /**
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = d.make("div", _xe.CSS.overlay, {}), i = d.make("div", _xe.CSS.overlayContainer, {}), s = d.make("div", _xe.CSS.rect, {});
    ...
    return new Promise((t) => {
      ...
      if (e.length === 0)
        ...
        const s = e.map(({ type: r, data: l, tunes: a, id: c }) => {
          o.available.has(r) === false && (X(`Tool «${r}» is not found. Check 'tools' property at the Editor.js config.`, "warn"), l = this.composeStubDataForTool(r, l, c), r = o.stubTool);
          let u;
          try {
            u = i.composeBlock({
              id: c,
...
var bs = class {
   ...
   */
  get(e) {
    const { class: t, isInternal: o = false, ...i } = this.config[e], s = this.getConstructor(t), r = t[et.IsTune];
    return new s({
      name: e,
      constructable: t,
      config: i,
...
var fo = class {
  ...
  handleClick() {
    ...
    let a;
    l.top > 0 ? a = Math.abs(r.top) - Math.abs(l.top) : a = Math.abs(r.top) + l.height, window.scrollBy(0, -1 * a), this.api.blocks.move(e - 1), this.api.toolbar.toggleBlockSettings(true);
  }
};
fo.isTune = true;
