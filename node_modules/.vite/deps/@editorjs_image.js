  ...
  (function(a, s) {
    ...
    return function(a) {
      ...
      return r.m = a, r.c = s, r.d = function(e, o, d) {
        ...
        if (r.r(d), Object.defineProperty(d, "default", { enumerable: true, value: e }), 2 & o && typeof e != "string") for (var v in e) r.d(d, v, (function(l) {
          return e[l];
        }).bind(null, v));
        return d;
      }, r.n = function(e) {
...
var P = class _P {
   ...
   */
  set data(i) {
    this.image = i.file, this._data.caption = i.caption || "", this.ui.fillCaption(this._data.caption), _P.tunes.forEach(({ name: a }) => {
